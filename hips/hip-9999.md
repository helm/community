...
There will be three kinds of plugins in the new system: Default Behavior plugins, Alternative Behavior plugins, and CLI plugins.
...
- Create examples of each kind of plugin (Alternative Behavior plugin and CLI plugin) for the new plugin system that contributors can use as a model for their own plugins
